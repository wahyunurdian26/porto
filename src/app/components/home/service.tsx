    ...
    return (
        <div className="rounded-2xl bg-white p-6 shadow dark:bg-black dark:shadow-dark lg:col-span-2">
            ...
            <div className="mt-6 grid grid-cols-2 gap-6 md:grid-cols-4">
                <div className="group">
                    <div className="group-hover:animate-rotate-x group-hover:animate-duration-[2000ms] group-hover:animate-once group-hover:animate-ease-linear rounded-2xl bg-light p-2 text-center dark:bg-dark-2 md:p-4 dark:group-hover:border-primary dark:group-hover:border-[1px]">
